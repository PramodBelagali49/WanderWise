const sampleListings = [
  {
    ...
    description: "Bask in the beauty of the Aegean Sea from this stunning whitewashed villa perched on a cliff in Santorini.",
    image: {
  ...
  },
  {
    ...
    description: "Nestled in the French Alps, this charming chalet offers breathtaking views and direct access to ski trails.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Unwind by the river in this rustic cabin surrounded by the wild beauty of Patagonia's untouched landscapes.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Experience Berlin's vibrant culture from this sleek, modern loft in the trendy Kreuzberg district.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Immerse yourself in nature in this eco-friendly bungalow steps away from Tulum's pristine beaches.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Relax by Lake Wakatipu in this serene retreat with stunning mountain views in New Zealand's adventure capital.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Sleep under the stars in this luxurious tented camp amidst the rolling dunes of the Sahara.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Enjoy dramatic sea views from this quaint cottage perched on the rugged cliffs of Cornwall.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Live above the clouds in this sleek penthouse with panoramic views of Singapore's dazzling skyline.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Savor the taste of fine wine in this elegant estate surrounded by rolling vineyards in Bordeaux.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Wake up to the sound of waves in this idyllic beach hut on a secluded Seychelles island.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Reconnect with nature in this cozy lodge surrounded by towering pines in Canada's wilderness.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Soak in the charm of Lisbon from this sunny rooftop apartment overlooking the Tagus River.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Experience nomadic life in this traditional yurt set against the vast Mongolian steppes.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Unwind in paradise in this luxurious villa with direct access to Mauritius' turquoise waters.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Escape to the lavender fields of Provence in this charming farmhouse with rustic elegance.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Stay warm in this cozy cabin with stunning views of Iceland's glaciers and northern lights.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Dive into the bustling energy of Seoul from this chic studio in the heart of Gangnam.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Relax with panoramic ocean views from this modern retreat along Cape Town's stunning coastline.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Overlook the colorful Amalfi Coast from this luxurious villa with a private terrace.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Surround yourself with the sounds of the rainforest in this secluded cabin near the Great Barrier Reef.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Enjoy iconic views of Sydney Harbour from this stylish house near the Opera House.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Ski into this cozy lodge surrounded by the powdery snow of Japan's northern island.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Live over the water in this luxurious bungalow with crystal-clear lagoons all around.",
    image: {
      filename: "listingimage",
      url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    },
  ...
  },
  {
    ...
    description: "Step into old-world charm in this beautifully restored townhouse in Prague's historic center.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Relax by Lake Lucerne in this modern house with stunning views of the Swiss Alps.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Embrace laid-back vibes in this surfside shack steps from Byron Bay's golden beaches.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Cozy up in this converted barn surrounded by Vermont's rolling hills and autumn foliage.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Cruise the backwaters of Kerala in this traditional houseboat turned luxurious villa.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Stay near Hawaii's active volcanoes in this rustic cabin with views of lava flows.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Live like a laird in this historic tower overlooking Edinburgh's ancient streets.",
    image: {
      filename: "listingimage",
      url: "https://images.unsplash.com/photo-1531218150217-54595bc2b934?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    },
  ...
  },
  {
    ...
    description: "Spot the Big Five from this luxurious tented camp in South Africa's Kruger National Park.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Sleep in a glass igloo under the aurora borealis in the snowy wilds of Finnish Lapland.",
    image: {
      filename: "listingimage",
      url: "https://images.unsplash.com/photo-1504851149312-7a075b496cc7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    },
  ...
  },
  {
    ...
    description: "Stay in a traditional cave house carved into the fairy chimneys of Cappadocia.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Enjoy sweeping views of the Golden Gate Bridge from this modern loft in the Bay Area.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Find peace in this serene villa overlooking the lush rice paddies of Bali's cultural heart.",
    image: {
      filename: "listingimage",
      url: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    },
  ...
  },
  {
    ...
    description: "Marvel at Norway's dramatic fjords from this cozy cabin perched above the water.",
    image: {
      filename: "listingimage",
      url: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    },
  ...
  },
  {
    ...
    description: "Sip tea amidst the misty hills of Darjeeling in this charming colonial-era cottage.",
    image: {
      filename: "listingimage",
      url: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    },
  ...
  },
  {
    ...
    description: "Sleep high in the treetops of the Amazon rainforest in this adventurous jungle hut.",
    image: {
      filename: "listingimage",
